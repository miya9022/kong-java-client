...
public class RetrofitOAuth2ProcessServiceTest extends BaseTest {
  ...
  private static final String API_URI = "v2/example"; // which actually "/v2/example", without the slash

  private static final String API_PROVISION_KEY = "1f2b8d4baadb4b6f93c82b1599cad575";
