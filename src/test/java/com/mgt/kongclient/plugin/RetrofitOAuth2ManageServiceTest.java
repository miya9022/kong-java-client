...
public class RetrofitOAuth2ManageServiceTest extends BaseTest {
  ...
  private static final String CONSUMER_ID = "53fe86c9-59d8-48c1-94ef-2e6142fadf85";


  // ------------------------------------------------------------------------------------

  private static final String appName = "testApp-20170807113035732";
  private static final String appClientId = "dc80e4ebf33445faafad96c1b4701d48";
  private static final String appClientSecret = "22435791881e40dc97fd05f28eb86488";
  private static final List<String> appRedirectUrl = new ArrayList<>();
